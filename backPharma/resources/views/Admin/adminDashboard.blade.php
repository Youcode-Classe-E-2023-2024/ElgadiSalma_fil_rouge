    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-xlg-3">
        <div class="box box-widget widget-user"> 
          ...
          <div class="widget-user-image"> <img class="img-circle" src="assets-dashboard/img/img3.jpg" alt="User Avatar"> </div>
      ...
      <div class="col-lg-6">
        <div class="info-box">
          <div class="box box-widget">
            <div class="box-header with-border">
              <div class="user-block"> <img class="img-circle" src="assets-dashboard/img/img1.jpg" alt="User Image"> <span class="username"><a href="#">Alexander Pierce</a></span> <span class="description">Shared publicly - 8:15 AM Today</span> </div>
            </div>
            <div class="box-body"> <img class="img-responsive pad" src="assets-dashboard/img/img6.jpg" alt="Photo">
              <p>I took this photo this morning. What do you guys think?</p>
              <button type="button" class="btn btn-default btn-xs"><i class="fa fa-share"></i> Share</button>
              <button type="button" class="btn btn-default btn-xs"><i class="fa fa-thumbs-o-up"></i> Like</button>
              <span class="pull-right text-muted">153 likes - 23 comments</span> </div>
            <div class="box-footer box-comments">
              <div class="box-comment"> <img class="img-circle img-sm" src="assets-dashboard/img/img3.jpg" alt="User Image">
                <div class="comment-text"> <span class="username"> Maria Gonzales <span class="text-muted pull-right">12:15 PM Today</span> </span> It is a long established fact that a reader will be assets-dashboardracted. </div>
              </div>
            </div>
            <div class="box-footer">
              <form action="#" method="post">
                <img class="img-responsive img-circle img-sm" src="assets-dashboard/img/img4.jpg" alt="Alt Text"> 
      ...
      <div class="col-lg-4 m-b-2">
        <div id="carouselExampleControls3" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active"> <img src="assets-dashboard/img/img7.jpg" class="img-responsive img-rounded" alt="User Image"></div>
            <div class="carousel-item"> <img src="assets-dashboard/img/img8.jpg" class="img-responsive img-rounded" alt="User Image"> </div>
            <div class="carousel-item"> <img src="assets-dashboard/img/img9.jpg" class="img-responsive img-rounded" alt="User Image"> </div>
          </div>
